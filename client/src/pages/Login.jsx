  ...
  return (
    <div className="mx-auto max-w-md px-4 py-10">
      <div className="rounded-2xl border bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-700 p-6 shadow-sm transition-colors duration-300">
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Use your email and password.</p>
        ...
        <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
          No account?{" "}
          <Link to="/register" className="font-medium text-gray-900 dark:text-white underline hover:text-gray-700 dark:hover:text-gray-200 transition-colors">
            Register
          </Link>
        </p>
      </div>
